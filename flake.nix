{
  ...
  inputs = {
    ...
    nixpkgs-24-05.url = "github:nixos/nixpkgs/nixos-24.05"; # FIXME: ???
    ...
    sops-nix.inputs.nixpkgs-stable.follows = "nixpkgs-24-05"; # FIXME: ???
    ...
    tl = {
      url = "github:nativerv/tl";
      # url = "git+file:///home/nrv/pr/tl?ref=HEAD";
      inputs.nixpkgs.follows = "nixpkgs-unstable";
    };
    scr = {
      url = "github:nativerv/scr";
  ...
  outputs = {
    ...
    in {
      ...
      # Other modules if any declared in ./nixos/module/generic, 
      # available through `self.nixosModules."module-type.module-name"`
      homeManagerModules = import ./home-manager/module { inherit flake self inputs; };
